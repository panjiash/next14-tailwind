...
export default function LoginPage() {
  ...
  return (
    <>
      <div className="h-screen flex-col w-100 flex justify-center items-center">
        {error !== "" && (
        ...
        <div className="bg-white shadow-md border border-gray-200 rounded-lg w-96 p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6" onSubmit={(e) => handleLogin(e)}>
            ...
            <button
              ...
              className={
                !isLoading
                  ...
                  : "w-full text-white bg-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600"
              }
            >
              {isLoading ? "Sign In..." : "Login to your account"}
            </button>
            <hr />
            <button
              type="button"
            ...
            >
              {isLoading ? "Sign In..." : "Login with google"}
            </button>
